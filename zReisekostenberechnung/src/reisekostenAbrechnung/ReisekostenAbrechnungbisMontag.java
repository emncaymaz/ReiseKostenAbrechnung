...
class KopiePanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		//Wenn ich "speichern kliche, passiert "
		if (e.getSource() == speichern) {
			...
			try {
				...
				// SQL-Komando erstellen und an die DB schicken
				String sql = String.format("INSERT INTO rechnung(tagegeld, uebernachtung, fahrkosten, sonstiges, summeverguetung) " + 
						                   "VALUES('%s','%s', '%s', '%s', '%s')",
...
public class ReisekostenAbrechnungbisMontag extends JFrame {

	public ReisekostenAbrechnungbisMontag(String titel) {
		super(titel);
